        ...
        *********************************************************************************************/
        public override void OnInspectorGUI()
        {
            ...
            if (m_spModuleFoldout.boolValue)
            {
                ...
                EditorGUILayout.LabelField("Warning: These modules are for reference only" +
                    "The modules in the MxMPreProcessor will be used for pre-processing", boldRedLabel);
