    ...
    public partial class MxMAnimator : MonoBehaviour
    {
        ...
        *********************************************************************************************/
        public void PreviewDebugFrame(ref MxMDebugFrame a_debugFrame)
        {
            ...
            m_enforceClipChange = a_debugFrame.EnforceClipChange;
            ...
            m_requiredTags = a_debugFrame.RequiredTags;
            m_favourTags = a_debugFrame.FavourTags;
        ...
        *********************************************************************************************/
        public void RecordDebugState()
        {
            ...
            debugFrame.RequiredTags = m_requiredTags;
            debugFrame.FavourTags = m_favourTags;
            ...
            debugFrame.EnforceClipChange = m_enforceClipChange;
            ...
            debugFrame.TimeSinceEventTriggered = m_timeSinceEventTriggered;
