    ...
    public struct ComputePose01Costs_VelCost : IJobParallelForBatch
    {
        ...
        public void Execute(int startIndex, int count)
        {
            for (int i = startIndex; i < startIndex + count; ++i)
            {
                ...
                float3 jointDist = ((jointDiff.c0 * jointDiff.c0) +
                ...
                float jointResultVelDist = ((jointResultVelDiff.x * jointResultVelDiff.x) +
    ...
    public struct ComputePose02Costs_VelCost : IJobParallelForBatch
    {
        ...
        public void Execute(int startIndex, int count)
        {
            for (int i = startIndex; i < startIndex + count; ++i)
            {
                ...
                float2 jointPosDist = ((jointPosDiff.c0 * jointPosDiff.c0) +
                ...
                float3 jointResultVelDist = ((jointResultVelDiff.c0 * jointResultVelDiff.c0) +
